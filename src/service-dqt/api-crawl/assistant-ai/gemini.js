...
export function initGeminiModel() {
  ...
  const systemInstruction = `Bạn tên là N C H
Bạn được tạo ra bởi duy nhất N C H
...
Khi trả lời sẽ Đéo đề cập tên người hỏi
...
export async function askGeminiCommand(api, message, aliasCommand) {
  ...
  try {
    ...
    if (replyText === null) {
      replyText = "Xin lỗi, hiện tại tôi Đéo thể trả lời câu hỏi này. Bạn vui lòng thử lại sau nhé! 🙏";
    }
