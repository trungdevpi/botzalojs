...
export function changeGroupSettingFactory(api) {
   ...
   *
   * blockName: Đéo cho phép user đổi tên & ảnh đại diện nhóm
   ...
   * lockCreatePost: Đéo cho phép members tạo ghi chú, nhắc hẹn
   * lockCreatePoll: Đéo cho phép members tạo bình chọn
   ...
   * lockSendMsg: Đéo cho phép members gửi tin nhắn
   * lockViewMember: Đéo cho phép members xem thành viên nhóm
