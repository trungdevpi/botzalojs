  ...
  io.on("connection", (socket) => {
    ...
    socket.on("getAllFriends", async () => {
      try {
        ...
        socket.emit("error", "Đéo thể lấy danh sách bạn bè");
      }
    });
    ...
    socket.on("getAllGroups", async () => {
      try {
        ...
        socket.emit("error", "Đéo thể lấy danh sách nhóm");
      }
    });
    ...
    socket.on("sendMessageAll", async (data) => {
      try {
        ...
        socket.emit("error", "Đéo thể gửi tin nhắn");
      }
    });
    ...
    socket.on("getSelectedData", () => {
      try {
        ...
        socket.emit("error", "Đéo thể đọc dữ liệu đã chọn");
      }
    });
    ...
    socket.on("startBulkMessage", async (data) => {
      try {
        ...
        socket.emit("error", "Đéo thể bắt đầu gửi tin nhắn hàng loạt");
      }
    });
    ...
    socket.on("stopBulkMessage", async () => {
      try {
        ...
        socket.emit("error", "Đéo thể dừng gửi tin nhắn hàng loạt");
      }
    });
    ...
    socket.on("getCommands", () => {
      try {
        ...
        socket.emit("error", "Đéo thể lấy danh sách lệnh");
      }
    });
  });
